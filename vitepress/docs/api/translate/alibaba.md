...
阿里翻译每月的前 100 万字符免费，超出的部分会按照 50 元 / 百万字符收取费用，费用由阿里翻译在它自己的阿里云官方网站收取，与 沙拉翻译 无关。
...
### 第三步：在 沙拉翻译 中填写 AccessKey

将上图中的【AccessKey ID】和【AccessKey Secret】填写进 沙拉翻译 的【设置页】-【接口设置】-【阿里翻译】中即可。
